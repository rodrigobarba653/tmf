import { corrugatedPTypeSpecMatrix } from "@/content/corrugated-p-type-spec-table";
...
export function CorrugatedPTypeSpecTable() {
  return (
    <div className="overflow-x-auto rounded-lg border border-neutral-200 shadow-sm">
      <table className="w-full min-w-[640px] border-collapse text-foreground">
        ...
        <tbody>
          {corrugatedPTypeSpecMatrix.map((group, gi) =>
